...
- Include only files changed for the user's request.
- Do not commit unrelated existing user changes.
- If the working tree contains unrelated changes, leave them untouched.
- Use a concise commit message that describes the completed request.
